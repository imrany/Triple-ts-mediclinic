            ...
            <form className="space-y-4 mt-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <Input
                    name="first_name"
                    defaultValue={editStaff?.first_name || ""}
                    required
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    name="last_name"
                    defaultValue={editStaff?.last_name || ""}
                    required
                  />
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    name="phone_number"
                    defaultValue={editStaff?.phone_number || ""}
                    required
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    name="national_id"
                    type="number"
                    defaultValue={editStaff?.national_id || ""}
                    required
                  />
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    name="department"
                    defaultValue={editStaff?.department || ""}
                    required
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    name="specialty"
                    defaultValue={editStaff?.specialty || ""}
                    required
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    name="experience"
                    defaultValue={editStaff?.experience || ""}
                  />
                </div>
                <div className="space-y-1.5">
