...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white font-[family-name:var(--font-geist-sans)] flex flex-col items-center justify-center p-6">
      {/* Main Content Container */}
      <div className="w-full max-w-2xl text-center">
        {/* Icon */}
        <div className="mb-8 relative">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-pink-100 rounded-full">
            <FolderX className="w-12 h-12 text-pink-800" />
          </div>
          <div className="absolute top-0 right-0 w-8 h-8 bg-white rounded-full shadow-md flex items-center justify-center animate-pulse">
            <span className="text-pink-800 font-bold text-xs">?</span>
          </div>
        </div>

        {/* Text Content */}
        <h1 className="text-4xl font-bold text-pink-800 mb-4">Page Not Found</h1>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg mb-8 text-left">
          <h2 className="font-semibold text-pink-800 mb-4">What you can try:</h2>
          <ul className="space-y-3">
            <li className="flex items-start">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-pink-100 flex items-center justify-center mr-3 mt-0.5">
            ...
            <li className="flex items-start">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-pink-100 flex items-center justify-center mr-3 mt-0.5">
                <span className="text-pink-800 font-bold text-xs">2</span>
              </div>
              <span className="text-gray-700">Use the search function to find what you're looking for</span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-pink-100 flex items-center justify-center mr-3 mt-0.5">
                <span className="text-pink-800 font-bold text-xs">3</span>
              </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            onClick={() => navigate(-1)}
            className="flex items-center justify-center gap-2 px-6 py-3 bg-white border border-pink-800 text-pink-800 rounded-lg hover:bg-pink-50 transition-all duration-200"
          >
          ...
          <Button 
            onClick={() => navigate("/")}
            className="flex items-center justify-center gap-2 px-6 py-3 bg-pink-800 text-white rounded-lg hover:bg-pink-900 transition-all duration-200"
          >
      ...
      <div className="mt-8 w-full max-w-md hidden sm:block">
        <div className="relative">
          <Input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-800 focus:border-transparent"
          />
