    ...
    <div className="font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <button onClick={()=>alert("Cannot request test, try again later")} className="flex flex-col items-center justify-center p-4 bg-pink-50 rounded-lg hover:bg-pink-100 transition">
          ...
          <button onClick={()=>alert("Cannot upload results, try again later")} className="flex flex-col items-center justify-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
          ...
          <button onClick={()=>alert("Cannot edit equipment status, try again later")} className="flex flex-col items-center justify-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition">
